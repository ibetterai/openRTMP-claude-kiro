...
// Tests for Darwin (macOS/iOS) Timer PAL Implementation
//
...
// =============================================================================
// Darwin Timer PAL Tests
// =============================================================================

class DarwinTimerPALTest : public ::testing::Test {
protected:
    void SetUp() override {
        timerPal_ = std::make_unique<darwin::DarwinTimerPAL>();
    }
    ...
    std::unique_ptr<darwin::DarwinTimerPAL> timerPal_;
};

TEST_F(DarwinTimerPALTest, ImplementsITimerPALInterface) {
    ITimerPAL* interface = timerPal_.get();
    EXPECT_NE(interface, nullptr);
}

TEST_F(DarwinTimerPALTest, NowReturnsValidTimePoint) {
...
TEST_F(DarwinTimerPALTest, NowIsMonotonicallyIncreasing) {
...
TEST_F(DarwinTimerPALTest, GetMonotonicMillisReturnsNonZero) {
    uint64_t millis = timerPal_->getMonotonicMillis();
    EXPECT_GT(millis, 0u);
}

TEST_F(DarwinTimerPALTest, GetMonotonicMillisIsMonotonicallyIncreasing) {
...
TEST_F(DarwinTimerPALTest, ScheduleOnceReturnsValidHandle) {
...
TEST_F(DarwinTimerPALTest, ScheduleOnceCallbackFires) {
    std::atomic<bool> called{false};
...
TEST_F(DarwinTimerPALTest, ScheduleOnceWithZeroDelayFiresImmediately) {
    std::atomic<bool> called{false};
...
TEST_F(DarwinTimerPALTest, ScheduleRepeatingReturnsValidHandle) {
...
TEST_F(DarwinTimerPALTest, ScheduleRepeatingCallbackFiresMultipleTimes) {
    std::atomic<int> callCount{0};
...
TEST_F(DarwinTimerPALTest, CancelOneShotBeforeFiring) {
    std::atomic<bool> called{false};
...
TEST_F(DarwinTimerPALTest, CancelRepeatingTimer) {
    std::atomic<int> callCount{0};
...
TEST_F(DarwinTimerPALTest, CancelInvalidHandleReturnsError) {
    auto result = timerPal_->cancelTimer(INVALID_TIMER_HANDLE);
    EXPECT_TRUE(result.isError());
    EXPECT_EQ(result.error().code, TimerErrorCode::InvalidHandle);
}

TEST_F(DarwinTimerPALTest, CancelAlreadyCancelledTimerReturnsError) {
...
TEST_F(DarwinTimerPALTest, MultipleTimersCanRunConcurrently) {
...
TEST_F(DarwinTimerPALTest, TimerAccuracyWithinTolerance) {
...
TEST_F(DarwinTimerPALTest, ScheduleFromCallback) {
...
TEST_F(DarwinTimerPALTest, CancelFromCallback) {
    std::atomic<int> callCount{0};
